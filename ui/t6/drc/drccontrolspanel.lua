...
local f0_local0 = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3)
    ...
    return f1_arg0:addProfileDiscreteLeftRightSlider(f1_arg0.controller, f1_local0.label, f1_local0.name, f1_local0.min,
        f1_local0.max, f1_local0.hint)
end
    ...
    while f8_local2 ~= nil do
        if f8_local2.expanded then
            ...
            while f8_local3 ~= nil do
                ...
                if f8_local4 <= f8_local0 and f8_local0 <= f8_local6 and f8_local1 <= f8_local7 and f8_local5 <=
                    f8_local1 and f8_local3.m_focusable and not f8_local3:isInFocus() then
...
CoD.DrcControlsPanel.InitForRemote = function(f17_arg0)
    ...
    local f17_local1 = CoD.DrcExpandableButton.new(f17_arg0, f17_arg0.controller,
        Engine.Localize("PLATFORM_CONTROL_PRESETS_CAPS"))
    ...
    f17_local3:registerEventHandler(CoD.DrcRadioButtonList.RadioButtonActionEvent,
        CoD.DrcControlsPanel.PresetRadioButtonAction)
    ...
    local f17_local6 = CoD.DrcExpandableButton.new(f17_arg0, f17_arg0.controller,
        Engine.Localize("PLATFORM_CAMERA_SPEED_CAPS"))
    ...
    local f17_local8 = CoD.DrcExpandableButton.new(f17_arg0, f17_arg0.controller,
        Engine.Localize("PLATFORM_SENSITIVITY_CAPS"))
    ...
    local f17_local10 = CoD.DrcExpandableButton.new(f17_arg0, f17_arg0.controller,
        Engine.Localize("PLATFORM_DEAD_ZONES_CAPS"))
