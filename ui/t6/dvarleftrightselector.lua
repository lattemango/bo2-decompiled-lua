...
CoD.DvarLeftRightSelector.new = function ( f4_arg0, f4_arg1, f4_arg2, f4_arg3, f4_arg4 )
	local f4_local0 = CoD.LeftRightSelector.new( f4_arg1, UIExpression.DvarString( nil, f4_arg2 ), f4_arg3, f4_arg4, "cac_grid_nav" )
	f4_local0.m_dvarName = f4_arg2
	f4_local0.m_currentController = f4_arg0
	f4_local0.addChoice = CoD.DvarLeftRightSelector.AddChoice
	f4_local0.getCurrentValue = CoD.DvarLeftRightSelector.getCurrentValue
	return f4_local0
end
