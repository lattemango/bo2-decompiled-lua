...
CoD.DvarLeftRightSelector.AddChoice = function(ParentButton, LocalClientIndex, DvarName, Value, ExtraParams,
    StartingValue)
    local f2_local0 = nil
...
CoD.DvarLeftRightSelector.new = function(LocalClientIndex, ButtonName, DvarName, Description, f4_arg4)
    local DvarSelector = CoD.LeftRightSelector.new(ButtonName, UIExpression.DvarString(nil, DvarName), Description,
        f4_arg4, "cac_grid_nav")
