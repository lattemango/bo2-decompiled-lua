...
CoD.PrivateGameLobby.AddDLCWarning = function ( f10_arg0, f10_arg1 )
	...
	if CoD.isZombie == true then
		...
		self:setTopBottom( false, true, CoD.MapInfoImage.MapImageBottom - CoD.MapInfoImage.MapImageHeight + 6, CoD.MapInfoImage.MapImageBottom + f10_local0 )
	else
		self:setLeftRight( true, false, CoD.MapInfoImage.MapImageLeft, CoD.MapInfoImage.MapImageLeft + CoD.MapInfoImage.MapImageWidth )
		self:setTopBottom( false, true, CoD.MapInfoImage.MapImageBottom - CoD.MapInfoImage.MapImageHeight, CoD.MapInfoImage.MapImageBottom )
	end
	self:setAlpha( 0 )
