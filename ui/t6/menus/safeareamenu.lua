...
CoD.SafeArea.SafeArea_Move = function(SafeAreaMenu, ClientInstance)
    local safeAreaTweakable_vertical = tonumber(UIExpression.ProfileValueAsString(ClientInstance.controller,
        "safeAreaTweakable_vertical"))
    local safeAreaTweakable_horizontal = tonumber(UIExpression.ProfileValueAsString(ClientInstance.controller,
...
LUI.createMenu.SafeArea = function(LocalClientIndex)
    ...
    if UIExpression.IsInGame() == 1 then
        SafeAreaMenu = CoD.InGameMenu.New("SafeArea", LocalClientIndex,
            Engine.Localize("MENU_SAFE_AREA_ADJUSTMENT_CAPS"), CoD.isSinglePlayer)
    ...
    SafeAreaMenu.backButton = CoD.ButtonPrompt.new("secondary", Engine.Localize("MENU_BACK"), SafeAreaMenu,
        "safearea_back_button")
    ...
    if CoD.useMouse then
        ...
        if SafeAreaMenu.leftButtonPromptBar then
            ...
            SafeAreaMenu.leftButtonPromptBar:setTopBottom(false, false,
                SafeAreaMenu.height / 2 - CoD.ButtonPrompt.Height, SafeAreaMenu.height / 2)
        ...
        if SafeAreaMenu.rightButtonPromptBar then
            ...
            SafeAreaMenu.rightButtonPromptBar:setTopBottom(false, false,
                SafeAreaMenu.height / 2 - CoD.ButtonPrompt.Height, SafeAreaMenu.height / 2)
