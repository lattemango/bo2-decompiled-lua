...
CoD.SafeArea.SafeArea_Move = function ( f2_arg0, f2_arg1 )
	local f2_local0 = tonumber( UIExpression.ProfileValueAsString( f2_arg1.controller, "safeAreaTweakable_vertical" ) )
	local f2_local1 = tonumber( UIExpression.ProfileValueAsString( f2_arg1.controller, "safeAreaTweakable_horizontal" ) )
...
LUI.createMenu.SafeArea = function ( f8_arg0 )
	...
	f8_local0.close = CoD.Options.Close
	...
	f8_local0.buttonRepeaterUp = LUI.UIButtonRepeater.new( "up", "safearea_move_up" )
	f8_local0:addElement( f8_local0.buttonRepeaterUp )
	f8_local0.buttonRepeaterDown = LUI.UIButtonRepeater.new( "down", "safearea_move_down" )
	f8_local0:addElement( f8_local0.buttonRepeaterDown )
	f8_local0.buttonRepeaterLeft = LUI.UIButtonRepeater.new( "left", "safearea_move_left" )
	f8_local0:addElement( f8_local0.buttonRepeaterLeft )
	f8_local0.buttonRepeaterRight = LUI.UIButtonRepeater.new( "right", "safearea_move_right" )
	f8_local0:addElement( f8_local0.buttonRepeaterRight )
