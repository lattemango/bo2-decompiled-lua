...
local f0_local5 = function ( f12_arg0 )
	...
	if CoD.useMouse then
		...
		self:registerEventHandler( "leftmouseup", CoD.CardCarousel.MiniCardLeftMouseUp )
		self:registerEventHandler( "mouseenter", CoD.CardCarousel.MiniCardMouseEnter )
		self:registerEventHandler( "mouseleave", CoD.CardCarousel.MiniCardMouseLeave )
		self.card = f12_arg0
	end
...
CoD.CardCarousel.AddNewCard = function ( f16_arg0 )
	...
	self.border = CoD.Border.new( 2, CoD.offGray.r, CoD.offGray.g, CoD.offGray.b, 1 )
...
CoD.CardCarousel.new = function ( f28_arg0, f28_arg1, f28_arg2, f28_arg3, f28_arg4, f28_arg5, f28_arg6, f28_arg7 )
	local self = LUI.UIElement.new( f28_arg0 )
	local f28_local1 = CoD.CardCarousel.SpaceBetweenTitleAndCarousel
	local f28_local2 = CoD.CardCarousel.TopOffset
	CoD.CardCarousel.SetupDefaultParams( self, f28_arg1, f28_arg2, f28_arg3, f28_arg4, f28_arg5, f28_arg6 )
	local f28_local3 = f28_local1 + self.m_highlightedItemHeight
	local f28_local4 = f28_local3 + CoD.CardCarousel.MiniCarouselItemHeight + f28_local1
	CoD.CardCarousel.SetupMiniCarousel( self, f28_local3 )
	CoD.CardCarousel.SetupTitleAndHorizontalList( self, f28_local2, f28_local4 )
	if CoD.useMouse then
		CoD.CardCarousel.SetupMouseDragListener( self, f28_local2 )
	end
	if not f28_arg7 then
		CoD.CardCarousel.SetupHintTextContainer( self, f28_local4 )
	end
	CoD.CardCarousel.SetupDefaultFunctions( self )
	CoD.CardCarousel.RegisterEventHandlers( self, f28_arg7 )
