...
CoD.CoD9Button.SetBracketContainerStates = function(f1_arg0, f1_arg1, f1_arg2, f1_arg3)
    ...
    f1_arg0.container:setLeftRight(true, false, f1_arg0.container.leftOffset - CoD.CoD9Button.BracketSpacer -
        CoD.CoD9Button.BracketAnimDistance, f1_arg0.container.leftOffset + f1_local1 + CoD.CoD9Button.BracketSpacer +
        CoD.CoD9Button.BracketAnimDistance)
...
CoD.CoD9Button.ShowNewIcon = function(f4_arg0, f4_arg1)
    ...
    elseif f4_arg1 and not f4_arg0.lockImage then
        if not f4_arg0.newIcon then
            f4_arg0.newIcon = LUI.UIImage.new()
            f4_arg0.newIcon:setLeftRight(true, false, f4_arg0.container.textWidth + 10,
                f4_arg0.container.textWidth + 10 + CoD.CACUtility.ButtonGridNewImageWidth)
            f4_arg0.newIcon:setTopBottom(false, false, -CoD.CACUtility.ButtonGridNewImageHeight / 2,
...
CoD.CoD9Button.GainFocus = function(f5_arg0, f5_arg1)
    ...
    if CoD.isZombie == true then
        ...
        f5_arg0.container:setLeftRight(true, false, f5_arg0.container.leftOffset - CoD.CoD9Button.BracketSpacer,
            f5_arg0.container.leftOffset + f5_arg0.container.textWidth + CoD.CoD9Button.BracketSpacer)
...
CoD.CoD9Button.LoseFocus = function(f6_arg0, f6_arg1)
    ...
    if CoD.isZombie == true then
        ...
        f6_arg0.container:setLeftRight(true, false, f6_arg0.container.leftOffset - CoD.CoD9Button.BracketSpacer -
            CoD.CoD9Button.BracketAnimDistance,
            f6_arg0.container.leftOffset + f6_arg0.container.textWidth + CoD.CoD9Button.BracketSpacer +
                CoD.CoD9Button.BracketAnimDistance)
