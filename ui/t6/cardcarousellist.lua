...
local f0_local6 = function(f7_arg0, f7_arg1)
    if f7_arg1 then
        if not f7_arg0.newIcon then
            ...
            newIcon:setTopBottom(false, true, -12 - CoD.CACUtility.ButtonGridNewImageHeight / 2,
                -12 + CoD.CACUtility.ButtonGridNewImageHeight / 2)
...
local f0_local9 = function(f10_arg0, f10_arg1)
    local f10_local0 = CoD_CardCarouselList_TitleListContainer_GetNewTitleContainer(f10_arg0, f10_arg0.numTitles,
        f10_arg0.cardCarouselList.cardCarousels[f0_local7(f10_arg0.cardCarouselList)], 0)
...
local f0_local10 = function(f11_arg0, f11_arg1)
    local f11_local0 = CoD_CardCarouselList_TitleListContainer_GetNewTitleContainer(f11_arg0, 1,
        f11_arg0.cardCarouselList.cardCarousels[f0_local8(f11_arg0.cardCarouselList)], 0)
...
CoD.CardCarouselList.SetInitialCarousel = function(f12_arg0, f12_arg1, f12_arg2)
    if f12_arg1 ~= nil and f12_arg1 ~= f12_arg0.m_currentCardCarouselIndex then
        ...
        for f12_local3 = f12_arg1 + 1, f12_local0, 1 do
            f12_arg0.titleListContainer:addElement(CoD_CardCarouselList_TitleListContainer_GetNewTitleContainer(
                f12_local1, f12_local2, f12_arg0.cardCarousels[f12_local3], 1))
...
function CoD_CardCarouselList_TitleListContainer_GetNewTitleContainer(f19_arg0, f19_arg1, f19_arg2, f19_arg3)
    ...
    local titleText = f19_arg2.titleText
    if titleText == nil then
        return
    end
    local f19_local1 = {}
    f19_local1 = GetTextDimensions(titleText, CoD.fonts.Default, f19_arg0.elementSize)
...
CoD.CardCarouselList.Gamepad_Button = function(f23_arg0, f23_arg1)
    if f23_arg0.m_inputDisabled then
        return
    elseif f23_arg1.button ~= "up" and f23_arg1.button ~= "down" and f23_arg1.button ~= "left" and f23_arg1.button ~=
        "right" then
    ...
    elseif f23_arg1.down == true and (f23_arg1.button == "left" or f23_arg1.button == "right") then
        if CoD_CardCarousel_PerformEdgeBounce(f23_arg0.cardCarousels[f23_arg0.m_currentCardCarouselIndex],
            f23_arg1.button, f23_arg1.buttonRepeat) == true then
            return true
        else
            f23_arg0:dispatchEventToChildren(f23_arg1)
            return nil
        end
    elseif f23_arg1.down == true and (f23_arg1.button == "up" or f23_arg1.button == "down") and
        (f23_arg0.scrolling == nil or f23_arg0.scrolling == false) then
...
CoD.CardCarouselList.new = function(f25_arg0, f25_arg1, f25_arg2, f25_arg3, f25_arg4, f25_arg5, f25_arg6)
    ...
    self.cardCarouselSize = CoD.CardCarousel.TitleSize + CoD.CardCarousel.SpaceBetweenTitleAndCarousel +
                                CoD.CardCarousel.SpaceBetweenCarouselAndTitleList
...
CoD.CardCarouselList.AddCardCarousel = function(f26_arg0, f26_arg1, f26_arg2, f26_arg3)
    local f26_local0 = CoD.CardCarousel.new({
        ...
        alpha = 0
    }, f26_arg0.m_itemWidth, f26_arg0.m_itemHeight, f26_arg0.m_highlightedItemWidth, f26_arg0.m_highlightedItemHeight,
        f26_arg0.m_hintTextParams)
    ...
    if #f26_arg0.cardCarousels > 1 then
        ...
        f26_arg0.titleListContainer:addElement(CoD_CardCarouselList_TitleListContainer_GetNewTitleContainer(
            f26_arg0.titleListContainer, #f26_arg0.cardCarousels - 1, f26_local0, 1))
    end
    return f26_local0
end
