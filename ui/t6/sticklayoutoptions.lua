...
LUI.createMenu.StickLayout = function ( f17_arg0, f17_arg1 )
	...
	f17_local0.stickLayoutButtonList = CoD.ButtonList.new( {
		...
		rightAnchor = false,
		left = f17_local1,
		right = f17_local1 + CoD.ButtonList.DefaultWidth - 20,
		topAnchor = true,
		bottomAnchor = false,
	...
	if CoD.isPC then
		f17_local0.stickLayoutButtonList:setLeftRight( true, false, f17_local1, f17_local1 + 500 )
	end
	...
	if CoD.isWIIU then
		CoD.WiiUControllerSettings.SetCloseIfControllerChanges( f17_local0 )
	end
	return f17_local0
end
