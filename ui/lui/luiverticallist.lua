...
LUI.UIVerticalList.new = function ( f2_arg0 )
	...
	self.addElementToTop = LUI.UIVerticalList.AddElementToTop
	self.selectElementIndex = LUI.UIVerticalList.SelectElementIndex
	self.addNavigationFailSound = LUI.UIVerticalList.AddNavigationFailSound
	self.addNavigationFocusSound = LUI.UIVerticalList.AddNavigationFocusSound
	self:registerEventHandler( "gain_focus", LUI.UIVerticalList.gainFocus )
	self:registerEventHandler( "gain_focus_skip_disabled", LUI.UIVerticalList.gainFocusSkipDisabled )
	return self
end
