...
CoD.PersistentItemTombDisplay.UpdateQuest = function ( f3_arg0, f3_arg1 )
	...
	CoD.PersistentItemTombDisplay.UpdateQuestContainerAndTitle( f3_arg0, f3_arg1 )
end

CoD.PersistentItemTombDisplay.UpdateQuestContainerAndTitle = function ( f4_arg0, f4_arg1 )
