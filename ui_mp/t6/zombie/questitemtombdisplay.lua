...
CoD.QuestItemTombDisplay.PlayerClientFieldCount = 4
CoD.QuestItemTombDisplay.PlayerClientFieldName = "staff_player"
...
CoD.QuestItemTombDisplay.new = function ( f1_arg0 )
	...
	CoD.QuestItemTombDisplay.PlayerPieceInfo = {
		0,
		0,
		0,
		0
	...
	for f1_local0 = 1, CoD.QuestItemTombDisplay.PlayerClientFieldCount, 1 do
		f1_arg0:registerEventHandler( CoD.QuestItemTombDisplay.PlayerClientFieldName .. f1_local0, CoD.QuestItemTombDisplay.PlayerStaffOwner )
	end
...
CoD.QuestItemTombDisplay.PlayerStaffOwner = function ( f3_arg0, f3_arg1 )
	...
	local f3_local2 = tonumber( string.sub( f3_arg1.name, string.len( CoD.QuestItemTombDisplay.PlayerClientFieldName ) + 1 ) )
	...
	elseif 0 < f3_local0 then
		...
		CoD.QuestItemTombDisplay.PlayerPieceInfo[f3_local0] = 0
	end
	if 0 < f3_local1 then
		...
		CoD.QuestItemTombDisplay.PlayerPieceInfo[f3_local1] = f3_local2
	end
end
...
CoD.QuestItemTombDisplay.ScoreboardUpdate = function ( f5_arg0, f5_arg1 )
	...
	if f5_arg0.statusIcons then
		for f5_local0 = 1, #CoD.QuestItemTombDisplay.PlayerPieceInfo, 1 do
			local f5_local3 = CoD.QuestItemTombDisplay.PlayerPieceInfo[f5_local0]
			if f5_local3 == 0 then
				f5_arg0.statusIcons[f5_local0].playerID:setText( "" )
			else
				f5_arg0.statusIcons[f5_local0].playerID:setRGB( CoD.Zombie.PlayerColors[f5_local3].r, CoD.Zombie.PlayerColors[f5_local3].g, CoD.Zombie.PlayerColors[f5_local3].b )
				f5_arg0.statusIcons[f5_local0].playerID:setText( Engine.Localize( "ZMUI_PLAYER_NUM_" .. f5_local3 ) )
			end
		end
	end
