...
LUI.createMenu.AfterlifeArea = function ( f1_arg0 )
	...
	self:setLeftRight( false, false, -CoD.HudAfterlifeDisplay.IconWidth / 2, CoD.HudAfterlifeDisplay.IconWidth / 2 )
	self:setTopBottom( false, true, -CoD.HudAfterlifeDisplay.IconHeight - f1_local1, -f1_local1 )
	self:setAlpha( 0 )
	f1_local0.bottomScaleContainer:addElement( self )
	f1_local0.afterlifeIconContainer = self
	...
	f1_local7:setLeftRight( false, true, -CoD.HudAfterlifeDisplay.InventoryWidth + f1_local5, f1_local5 )
	f1_local7:setTopBottom( false, true, -CoD.HudAfterlifeDisplay.InventoryHeight - f1_local6, -f1_local6 )
	f1_local7:setAlpha( 0 )
	f1_local0.bottomRightScaleContainer:addElement( f1_local7 )
	f1_local0.afterLifeInventoryContainer = f1_local7
	...
	f1_local7:addElement( afterlifeInventoryCount )
