...
LUI.createMenu.CraftablesTombArea = function ( f1_arg0 )
	...
	self:setTopBottom( true, false, 0, CoD.CraftablesTomb.ContainerHeight )
	local f1_local5 = CoD.PersistentItemTombDisplay.new( self )
	...
	local f1_local15 = LUI.UIElement.new()
	f1_local15:setLeftRight( false, true, -f1_local14 - f1_local12, -f1_local12 )
	f1_local15:setTopBottom( true, false, f1_local13, f1_local14 + f1_local13 )
	f1_local15:setAlpha( 0 )
	f1_local0.topRightScaleContainer:addElement( f1_local15 )
	f1_local0.captureZoneWheelContainer = f1_local15
	...
	local f1_local18 = LUI.UIElement.new()
	f1_local18:setLeftRight( true, false, 0, CoD.CraftablesTomb.OneInchIconWidth )
	f1_local18:setTopBottom( false, true, -CoD.CraftablesTomb.OneInchIconHeight - f1_local17, -f1_local17 )
	f1_local18:setAlpha( 0 )
	f1_local0.bottomLeftScaleContainer:addElement( f1_local18 )
	f1_local0.tabletContainer = f1_local18
	...
	f1_local18:addElement( tabletIcon )
