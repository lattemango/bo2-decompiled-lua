...
LUI.createMenu.TimeBombArea = function ( f1_arg0 )
	...
	local f1_local1 = CoD.RoundStatus.ChalkSize
	local self = LUI.UIElement.new()
	self:setLeftRight( true, false, 0, CoD.HudTimeBomb.IconWidth )
	self:setTopBottom( false, true, -CoD.HudTimeBomb.IconHeight - f1_local1, -f1_local1 )
	self:setAlpha( 0 )
	f1_local0.scaleContainer:addElement( self )
	f1_local0.timeBombContainer = self
