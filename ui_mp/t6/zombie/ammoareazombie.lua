...
LUI.createMenu.AmmoAreaZombie = function ( f1_arg0 )
	...
	self:setLeftRight( false, true, -CoD.AmmoAreaZombie.CircleSize - f1_local2, -f1_local2 )
	self:setTopBottom( false, true, -CoD.AmmoAreaZombie.CircleSize - f1_local3, -f1_local3 )
	f1_local0:addElement( self )
	self.id = "DpadCircle"
	self.visible = true
	self:registerEventHandler( "hud_update_actionslots", CoD.AmmoAreaZombie.UpdateActionSlots )
	self:registerEventHandler( "hud_update_inventory_weapon", CoD.AmmoAreaZombie.UpdateInventoryWeapon )
	self:registerEventHandler( "hud_fade_dpad", CoD.AmmoAreaZombie.UpdateFading )
	local f1_local5 = 256
	...
	self:addElement( f1_local0.weaponLabelContainer )
			...
			if self ~= nil then
				...
				if CoD.isPC then
					...
					if f2_local11 ~= nil then
						...
						self.keyPrompt = LUI.UIText.new( f2_local11 )
						...
						self.keyPrompt:setLeftRight( false, true, -f2_local14 - 120, -f2_local14 - 10 )
						self.keyPrompt:setAlpha( 0.5 )
						self.keyPrompt:setAlignment( LUI.Alignment.Right )
						self:registerAnimationState( "KeyPrompt", f2_local11 )
						self:addElement( self.keyPrompt )
						if CoD.useController and Engine.LastInput_Gamepad() then
							CoD.AmmoAreaZombie.ActionSlotInputSourceChanged( self, {
								source = 0
							} )
						else
							CoD.AmmoAreaZombie.ActionSlotInputSourceChanged( self, {
...
CoD.AmmoAreaZombie.UpdateAmmo = function ( f6_arg0, f6_arg1 )
	...
	if f6_arg0.hideAmmo then
		...
		f6_local2 = f6_local2 - f6_local8
		f6_local14 = f6_local14 + 1
		f6_local11, f6_local12, f6_local13 = CoD.AmmoAreaZombie.GetThreeDigits( f6_arg1.ammoInClip )
		...
		if f6_arg1.ammoInDWClip then
			...
			f6_arg0.ammoDigits[f6_local14]:setTopBottom( false, true, f6_local5, f6_local5 + f6_local6 )
			f6_local2 = f6_local2 - f6_local4
			local f6_local15 = f6_arg1.lowDWClip
			f6_local14 = f6_local14 + 1
			f6_local11, f6_local12, f6_local13 = CoD.AmmoAreaZombie.GetThreeDigits( f6_arg1.ammoInDWClip )
