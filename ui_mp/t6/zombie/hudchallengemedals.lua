...
CoD.HudChallengeMedals.MedalTopStart = CoD.Perks.TopStart
...
LUI.createMenu.ChallengeMedalsArea = function ( f1_arg0 )
	...
	self:setLeftRight( true, true, 5, 0 )
	self:setTopBottom( false, true, -CoD.HudChallengeMedals.IconHeight - f1_local1, -f1_local1 )
	f1_local0.scaleContainer:addElement( self )
	f1_local0.medalsContainer = self
	f1_local0.medals = {}
...
CoD.HudChallengeMedals.UpdateMedalDisplay = function ( f3_arg0, f3_arg1 )
	...
	elseif f3_local0 == CoD.HudChallengeMedals.MEDAL_ON then
		...
		if f3_local3 then
			...
			self:setLeftRight( true, false, 0, f3_local4 )
			self:setTopBottom( true, false, 0, f3_local5 )
			self:setImage( CoD.HudChallengeMedals.ClientFieldNames[f3_local2].material )
			f3_arg0.medalsContainer:addElement( self )
			self.medalId = f3_local1
