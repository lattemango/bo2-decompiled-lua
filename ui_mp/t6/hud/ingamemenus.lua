require( "T6.CoDBase" )
require( "T6.MFPopup" )
require( "T6.HUD.EndGamePopup" )
require( "T6.HUD.team_marinesopfor" )

if CoD.isZombie == true then
	require( "T6.Zombie.RestartGamePopupZombie" )
else
	require( "T6.HUD.changeclass" )
end
require( "T6.HUD.class" )
require( "T6.Options" )
...
CoD.InGameMenu.BackButtonPressed = function ( f2_arg0, f2_arg1 )
	if CoD.isZombie == true and UIExpression.IsDemoPlaying( f2_arg1.controller ) == 0 and CoD.InGameMenu.m_unpauseDisabled and CoD.InGameMenu.m_unpauseDisabled[f2_arg1.controller + 1] ~= nil and CoD.InGameMenu.m_unpauseDisabled[f2_arg1.controller + 1] > 0 then
	...
	if not f2_arg0.previousMenuName then
		if CoD.isZombie == true and UIExpression.IsDemoPlaying( f2_arg1.controller ) == 0 then
		...
		Engine.SendMenuResponse( f2_arg1.controller, "vcs", "ingame_menu_closed" )
	end
end

CoD.InGameMenu.StartButtonPressed = function ( f3_arg0, f3_arg1 )
	if CoD.isZombie == true and UIExpression.IsDemoPlaying( f3_arg1.controller ) == 0 then
...
CoD.InGameMenu.CloseAllInGameMenus = function ( f5_arg0, f5_arg1 )
	if CoD.isZombie == true and UIExpression.IsDemoPlaying( f5_arg1.controller ) == 0 then
