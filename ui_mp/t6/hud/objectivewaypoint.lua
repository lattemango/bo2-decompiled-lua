...
CoD.ObjectiveWaypoint.Clamped = function ( f4_arg0, f4_arg1 )
	if f4_arg0.edgePointerContainer.setupEdgePointer then
...
CoD.ObjectiveWaypoint.update = function ( f9_arg0, f9_arg1 )
	...
	local f9_local3 = Engine.GetObjectiveEntity( f9_local0, f9_local1 )
	if f9_local3 and not f9_local2 then
		f9_arg0:setupEntityContainer( f9_local3, 0, 0, f9_arg0.zOffset )
	else
		local f9_local4, f9_local5, f9_local6 = Engine.GetObjectivePosition( f9_local0, f9_local1 )
		f9_arg0:setupEntityContainer( -1, f9_local4, f9_local5, f9_local6 + f9_arg0.zOffset )
		if f9_local2 then
	...
	if not f9_arg0:shouldShow( f9_arg1 ) then
		...
		local f9_local5 = Engine.GetTeamID( f9_local0, Engine.GetPredictedClientNum( f9_local0 ) )
		local f9_local6 = Engine.ObjectiveIsTeamUsing( f9_local0, f9_arg0.index, f9_local5 )
		local f9_local7 = Engine.ObjectiveIsAnyOtherTeamUsing( f9_local0, f9_arg0.index, f9_local5 )
		f9_arg0:updatePlayerUsing( f9_local0, f9_local6, f9_local7 )
		f9_arg0:updateProgress( f9_local0, f9_local6, f9_local7 )
	end
end
