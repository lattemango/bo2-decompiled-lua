...
f0_local2 = function(f3_arg0, f3_arg1)
    ...
    if UIExpression.IsVisibilityBitSet(f3_local0, CoD.BIT_BOMB_TIMER) == 0 and
        UIExpression.IsVisibilityBitSet(f3_local0, CoD.BIT_BOMB_TIMER_A) == 0 and
        UIExpression.IsVisibilityBitSet(f3_local0, CoD.BIT_BOMB_TIMER_B) == 0 then
