...
CoD.MOTD.PopulateActionText = function ( f1_arg0, f1_arg1, f1_arg2, f1_arg3 )
	f1_arg0:addElement( CoD.ButtonPrompt.new( "alt1", Engine.Localize( f1_arg1 ), f1_arg3, f1_arg2, false, false, false, false, "P" ) )
end
...
LUI.createMenu.MOTD = function ( f12_arg0 )
	...
	if f12_local2.isValid == true then
		...
		self:setLeftRight( true, false, 0, CoD.MOTD.MessageWidth )
		self:setTopBottom( true, false, f12_local3, f12_local3 + CoD.textSize.Big )
		self:setFont( CoD.fonts.Big )
		self:setRGB( CoD.BOIIOrange.r, CoD.BOIIOrange.g, CoD.BOIIOrange.b )
		self:setText( f12_local2.title )
		f12_local0:addElement( self )
		f12_local3 = f12_local3 + CoD.textSize.Big + 10
		local f12_local5 = LUI.UIElement.new()
		f12_local5:setLeftRight( true, false, 0, CoD.MOTD.MessageWidth )
		f12_local5:setTopBottom( true, false, f12_local3, f12_local3 + CoD.MOTD.MessageHeight )
		...
		f12_local5:addElement( f12_local6 )
		f12_local3 = f12_local3 + CoD.MOTD.MessageHeight
		local f12_local7 = LUI.UIElement.new()
		f12_local7:setLeftRight( true, false, 0, CoD.MOTD.MessageWidth )
		f12_local7:setTopBottom( true, false, f12_local3, f12_local3 + CoD.textSize.Condensed )
		f12_local7:addElement( CoD.Border.new( 1, 0.5, 0.5, 0.5, 0.2, -3 ) )
		...
		f12_local7:addElement( f12_local8 )
		CoD.MOTD.AddAction( f12_local0, f12_local7, f12_local2.action, f12_local2.actionContext, f12_local2.actionString )
		...
		if f12_local2.bannerImage ~= "" then
			...
			local f12_local27 = LUI.UIElement.new()
			f12_local27:setLeftRight( true, true, f12_local25, 0 )
			f12_local27:setTopBottom( false, false, -f12_local13 + 5, -f12_local13 + 5 + f12_local12 )
			f12_local27:setAlignment( LUI.Alignment.Left )
			bannerContainer:addElement( f12_local27 )
			...
			CoD.MOTD.AddAction( f12_local0, f12_local27, f12_local0.bannerAction, f12_local0.bannerActionContext, f12_local0.bannerActionString )
		end
	end
