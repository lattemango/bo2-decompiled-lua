...
require( "T6.Menus.RestrictItems" )
require( "T6.Menus.RestrictWeapons" )
...
f0_local0 = function ( f2_arg0 )
	f2_arg0.disableCACSelector = f2_arg0:addGametypeSetting( f2_arg0:getOwner(), "disableCAC", true )
	f2_arg0.maxAllocationSelector = f2_arg0:addGametypeSetting( f2_arg0:getOwner(), "maxAllocation", true )
	f2_arg0.primaryWeaponsButton = f2_arg0.buttonList:addButton( Engine.Localize( "MENU_RESTRICT_PRIMARY_WEAPONS_CAPS" ) )
	f2_arg0.primaryWeaponsButton:setActionEventName( "restrict_primary_weapons" )
	...
	f2_arg0.secondaryWeaponsButton:setActionEventName( "restrict_secondary_weapons" )
	...
	f2_arg0.attachmentsButton:setActionEventName( "restrict_attachments" )
	...
	f2_arg0.perks1Button:setActionEventName( "restrict_perks1" )
	...
	f2_arg0.perks2Button:setActionEventName( "restrict_perks2" )
	...
	f2_arg0.perks3Button:setActionEventName( "restrict_perks3" )
	...
	f2_arg0.lethalsButton:setActionEventName( "restrict_lethals" )
	...
	f2_arg0.tacticalsButton:setActionEventName( "restrict_tacticals" )
	...
	f2_arg0.bonusCardsButton:setActionEventName( "restrict_bonus_cards" )
