...
require( "T6.PlaylistButton" )
require( "T6.Menus.SearchPreferencesPopup" )
...
CoD.PlaylistSelection.AddCategoryButtons = function ( f2_arg0, f2_arg1 )
	...
	local f2_local1 = f0_local0( f2_local0, UIExpression.ProfileInt( f2_arg1, "playlist_" .. f2_arg0.filter ) )
	local f2_local2 = 1
	...
	for f2_local7, f2_local8 in ipairs( f2_local0 ) do
		if f2_local8.filter == f2_arg0.filter then
			...
			f2_local6:setLabel( UIExpression.ToUpper( nil, f2_local8.name ) )
...
CoD.PlaylistSelection.CategoryButtonAction = function ( f5_arg0, f5_arg1 )
	...
	elseif f5_local0.partyMissingDLC == true then
		...
		CoD.ButtonList.EnableInput( f5_arg0.playlistButtonList )
...
CoD.PlaylistSelection.PlaylistIsLocked = function ( f7_arg0, f7_arg1 )
	if CoD.isPS3 and UIExpression.DvarBool( nil, "tu2_luiHacksDisabled" ) == 0 then
		if f7_arg1.index == 57 and UIExpression.GetDStat( f7_arg0, "PlayerStatsList", "RANKXP", "StatValue" ) >= 30100 then
			local f7_local0 = 5
			local f7_local1 = 10
			local f7_local2 = UIExpression.TableLookup( f7_arg0, CoD.rankTable, 0, f7_local1, f7_local0 )
			f7_arg1.locked = true
...
CoD.PlaylistSelection.AddPlaylistButtons = function ( f8_arg0, f8_arg1, f8_arg2 )
	...
	local f8_local1 = UIExpression.ProfileInt( f8_arg1, "playlist_" .. f8_arg0.filter )
	local f8_local2 = 0
	for f8_local6, f8_local7 in ipairs( f8_local0 ) do
		local f8_local8 = CoD.PlaylistButton.new( {
			...
			top = 0,
			bottom = CoD.CoD9Button.Height
		}, "playlist_button_action", "playlist_button_gain_focus", "playlist_button_lose_focus", f8_local7, f8_local6, categoryID )
		f8_local8:setLabel( UIExpression.ToUpper( nil, f8_local7.name ) )
...
CoD.PlaylistSelection.PlaylistBack = function ( f10_arg0, f10_arg1 )
	...
	CoD.ButtonList.DisableInput( f10_arg0.playlistButtonList )
	...
	if CoD.useMouse then
		f10_arg0.playlistButtonList.m_backReady = nil
	end
end
...
CoD.PlaylistSelection.UpdateInfo = function ( f11_arg0, f11_arg1 )
	...
	f11_local4 = UIExpression.FormatNumberWithCommas( nil, f11_local3 )
	if f11_arg1.playlists ~= nil then
		f11_arg0.infoContainer.playerCount:setText( Engine.Localize( "MENU_CATEGORY_USER_COUNT", f11_local4, UIExpression.FormatNumberWithCommas( nil, f11_arg0.totalCategoryPlayerCount ) ) )
	else
		f11_arg0.infoContainer.playerCount:setText( Engine.Localize( "MENU_PLAYLIST_USER_COUNT", f11_local4, UIExpression.FormatNumberWithCommas( nil, f11_arg0.totalPlaylistPlayerCount ) ) )
	end
...
CoD.PlaylistSelection.AddSearchPreferencesButtonPrompt = function ( f12_arg0 )
	f12_arg0.searchPreferencesButton = CoD.ButtonPrompt.new( "alt1", Engine.Localize( "MPUI_SEARCH_PREFERENCES" ), f12_arg0, "button_prompt_search_preferences", false, false, false, false, "S" )
...
LUI.createMenu.PlaylistSelection = function ( f14_arg0 )
	local f14_local0 = CoD.Menu.New( "PlaylistSelection" )
	...
	local f14_local1 = CoD.CoD9Button.Height
	local f14_local2 = (CoD.Menu.Width - f14_local1 * 2) / 3
	local f14_local3 = 0
	...
	f14_local3 = f14_local3 + f14_local2 - f14_local1
	f14_local0.selectionContainerWidth = f14_local2
	...
	f14_local3 = f14_local3 + f14_local2
	if CoD.useMouse then
		f14_local0.playlistButtonList:setHandleMouseButton( true )
		f14_local0.playlistButtonList:registerEventHandler( "leftmouseup_outside", CoD.MainMenu.FlyoutBack )
		if f14_local0.filter ~= "leaguematch" then
			CoD.ButtonList.DisableInput( f14_local0.playlistButtonList )
		end
	end
	...
	f14_local3 = f14_local3 + f14_local2
	local f14_local8 = 256
	local f14_local9 = f14_local8
	if f14_local0.filter == "leaguematch" then
		f14_local8 = 384
		f14_local9 = f14_local8 / 2
	end
	f14_local6 = 0
	f14_local0.infoContainer.infoWidth = f14_local5
	...
	f14_local0.infoContainer.titleElement = LUI.UIText.new( {
		...
		bottomAnchor = false,
		top = f14_local6,
		bottom = f14_local6 + CoD.textSize.Big,
		font = CoD.fonts.Big,
	...
	f14_local6 = f14_local6 + CoD.textSize.Big * 2 + 5
	f14_local0.infoContainer.description = LUI.UIText.new( {
		...
		bottomAnchor = false,
		top = f14_local6,
		bottom = f14_local6 + CoD.textSize.Default,
	...
	if f14_local0.filter == "leaguematch" then
		f14_local6 = f14_local6 + CoD.textSize.Big + 178
	else
		f14_local6 = f14_local6 + CoD.textSize.Big + 115
	end
	f14_local0.infoContainer.playerCount = LUI.UIText.new()
	f14_local0.infoContainer.playerCount:setLeftRight( true, false, 0, 0 )
	f14_local0.infoContainer.playerCount:setTopBottom( true, false, f14_local6, f14_local6 + CoD.textSize.Default )
	...
	f14_local7 = f14_local7 + CoD.textSize.Big + 5
	...
	f14_local7 = f14_local7 + CoD.textSize.Default * 6
